...
| <a name="input_kms_key_administrators_add_current"></a> [kms\_key\_administrators\_add\_current](#input\_kms\_key\_administrators\_add\_current) | Specifies wheter the current identity should be added as a key administrator for the KMS key | `bool` | `true` | no |
